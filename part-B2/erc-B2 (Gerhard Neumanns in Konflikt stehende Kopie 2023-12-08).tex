...
\cite{Inerf,RePOSE,chen2020category} investigate the interactive refinement of 6D pose estimation via online rendering, however, such functionality is not integrated in recent foundation models. %\todo{Investigate more papers on the online correction of 6D pose and segmentation. Consult with experts like Rainer?} 
...
%We have advanced in 6D pose estimation. In \cite{duffhauss22MV6D}\todo{duffhausRAL}, we adapted a 6D pose estimation method for multi-camera setups and symmetric objects. Effective on large datasets like YCB-Video \cite{xiang2018posecnn}, fine-tuning these models for smaller, specific cases is challenging. To address this, we developed a category-agnostic 6D pose estimator \cite{gao2023sad} needing only 10-20 annotated images, though it lags behind larger models in accuracy. Our project aims to improve category-agnostic estimators beyond category-specific models.
...
%\todo{Add 6D pose estimation work from ning and fabian}
